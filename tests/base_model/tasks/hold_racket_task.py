...
import os
import time
from models import HoldRacketXGBGenerator
from config import hold_racket_config as config
from config import base_config

def run_hold_racket_task(n_trials=None, use_gpu=None):
    """
    執行慣用手分類任務
    ...
    # 創建任務的模型生成器
    model = HoldRacketXGBGenerator(use_gpu=use_gpu)
