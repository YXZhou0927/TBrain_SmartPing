...
class PlayerPredictor():
    """
    一個用於羽毛球選手預測的類別，包含數據準備、模型訓練、預測和提交生成的功能。
    """
    def __init__(self, train_info: pd.DataFrame, train_data_dir: Union[str, Path], test_info: pd.DataFrame, test_data_dir: Union[str, Path], sample_submission_path: Union[str, Path]):
        ...
        self.sample_submission_path = Path(sample_submission_path)
...
def run(train_info_path: Union[str, Path], train_data_dir: Union[str, Path], test_info_path: Union[str, Path], test_data_dir: Union[str, Path], sample_submission_path: Union[str, Path]):
    predictor = PlayerPredictor(
        train_info=pd.read_csv(str(train_info_path)),
...
if __name__ == "__main__":
    train_info_path = 'data/raw/39_Training_Dataset/train_info.csv'
    train_data_dir = 'data/raw/39_Training_Dataset/train_data'
    test_info_path = 'data/raw/39_Test_Dataset/test_info.csv'
    test_data_dir = 'data/raw/39_Test_Dataset/test_data'
    sample_submission_path = 'data/raw/39_Test_Dataset/sample_submission.csv'
    run(train_info_path, train_data_dir, test_info_path, test_data_dir, sample_submission_path)
    # 這裡可以添加測試代碼或其他功能